...
export default function Chat() {
    ...
    return (
        <div className="flex h-screen">
            {/* Sidebar */}
            <div className="w-[20%] border-r border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
                <div className="p-4">
                    <Button 
            ...
            <div className="flex-1 flex flex-col">
                ...
                <form
                    ...
                    className="fixed bottom-0 right-0 w-[80%] p-4 border-t dark:border-gray-800 bg-white dark:bg-gray-900"
                >
